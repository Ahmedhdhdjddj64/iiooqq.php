<?php
// ملف بوت اختصار الروابط 
// الملف ل استفاده 
// لوحه ادمن جميله
// يوزري إذا احتجت شيء @FFF_YFF
$token = "5899433656:AAHZZ-kjw8n7RshCYgDz0wck10KQrxQbeEM"; //توكنك
...
$start="
مرحباً $name 👋,
في بوت اختصار الروابط 🌐,
ارسل فقط الرابط لاختصارة ♻️,
ملحوظة ⚠️ :-
يجب ان يحتوي الرابط على https او http ✅
.
";
}
$a1 = 5921676302; //ايديك
$admin = array(0000,$a1,$hmo['admin']);
...
if($text != "/start"){
$get = json_decode(file_get_contents('https://zzze.ga/api/short-url.php?url='.$text));
if($get->marko == "true"){
bot('sendmessage',[
      'chat_id'=>$chat_id,
      "text"=>"
...
bot('sendmessage',[
      'chat_id'=>$chat_id,
      "text"=>"
عذراً عزيزى الرابط الذي ارسلتة غير صحيح !!
يرجى ان يحتوي الرابط على :- 
https
او 
http
وسيتم اختصار الرابط ✅
